      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="card group hover:shadow-purple-lg">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-secondary-600">Total Chats</p>
              <p class="text-2xl font-bold text-secondary-900">{{ stats.totalChats }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card group hover:shadow-purple-lg">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-secondary-600">Messages Today</p>
              <p class="text-2xl font-bold text-secondary-900">{{ stats.messagesToday }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card group hover:shadow-purple-lg">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-secondary-600">Active Groups</p>
              <p class="text-2xl font-bold text-secondary-900">{{ stats.activeGroups }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card group hover:shadow-purple-lg">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-secondary-600">Online Friends</p>
              <p class="text-2xl font-bold text-secondary-900">{{ stats.onlineFriends }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          <div class="card">
            <div class="flex items-center justify-between mb-6">
              <h2 class="text-xl font-bold text-secondary-900">Recent Chats</h2>
              <router-link to="/chat" class="text-primary-600 hover:text-primary-700 font-medium text-sm">
                View All
              </router-link>
            </div>
            ...
            <div v-else-if="recentChats.length === 0" class="text-center py-12">
              ...
              <h3 class="mt-2 text-sm font-medium text-secondary-900">No chats yet</h3>
              <p class="mt-1 text-sm text-secondary-500">Start a conversation to see your chats here.</p>
              <div class="mt-6">
                <router-link to="/chat" class="btn-primary">
            ...
            <div v-else class="space-y-4">
              <div
                ...
                :key="chat.id"
                class="flex items-center space-x-4 p-4 rounded-xl hover:bg-secondary-50 transition-all duration-300 cursor-pointer group"
              ...
              >
                <div class="relative">
                  ...
                  <div v-if="chat.unread_count > 0" class="absolute -top-1 -right-1 w-5 h-5 bg-error-500 text-white text-xs rounded-full flex items-center justify-center font-bold">
                    {{ chat.unread_count > 9 ? '9+' : chat.unread_count }}
                  </div>
                </div>
                <div class="flex-1 min-w-0">
                  <div class="flex items-center justify-between">
                    <p class="text-sm font-semibold text-secondary-900 truncate">{{ chat.name }}</p>
                    <p class="text-xs text-secondary-500">{{ formatTime(chat.updated_at) }}</p>
                  </div>
        ...
        <div class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-3">
              <button class="w-full flex items-center p-3 text-left rounded-xl hover:bg-primary-50 hover:text-primary-700 transition-all duration-300 group">
                <div class="w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-primary-200 transition-colors duration-300">
                  <svg class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                  </svg>
                </div>
                <div>
                  <p class="font-medium">Create Group</p>
                  <p class="text-sm text-secondary-500">Start a new group chat</p>
                </div>
              </button>
              ...
              <button class="w-full flex items-center p-3 text-left rounded-xl hover:bg-primary-50 hover:text-primary-700 transition-all duration-300 group">
                ...
                <div>
                  <p class="font-medium">Find Friends</p>
                  <p class="text-sm text-secondary-500">Search for users to chat</p>
                </div>
              </button>

              <router-link to="/profile" class="w-full flex items-center p-3 text-left rounded-xl hover:bg-primary-50 hover:text-primary-700 transition-all duration-300 group">
                <div class="w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-primary-200 transition-colors duration-300">
                  <svg class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                  </svg>
          ...
          <!-- Online Users -->
          <div class="card">
            <h3 class="text-lg font-semibold text-secondary-900 mb-4">Online Now</h3>
            <div v-if="onlineUsers.length === 0" class="text-center py-6">
              <p class="text-sm text-secondary-500">No users online</p>
            </div>
            <div v-else class="space-y-3">
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  <p class="text-sm font-medium text-secondary-900 truncate">{{ user.name }}</p>
